...
int main() {
    ...
    printf("Now the MASK is shifted to 4nd bit and 1s complement done %x\n", mask);

    int result = (a & mask);

    printf("The result after clearing is %x\n", result);

    int b = 0x128;//0000 0000 0000 0000 0000 0001 0010 1000
    int c;
    ...
    printf("Now the MASK is shifted to %d bit and is complement done %x\n", c, mask);
